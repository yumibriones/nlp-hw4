...
# train configuration
EXPERIMENT_NAME="defaults_lengths_dec_enc"  # name for logging and checkpointing
...
python3 train_t5.py \
    ...
    --max_new_tokens 384 \
    --finetune_scope decoder_plus_top_encoder \
