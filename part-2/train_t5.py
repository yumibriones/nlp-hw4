...
def main():
    ...
    if args.calc_dataset_stats:
        ...
        train_raw_df.to_csv(os.path.join('stats', f'{args.experiment_name}_train_raw_stats.csv'), index=True, header=False)
        train_processed_df.to_csv(os.path.join('stats', f'{args.experiment_name}_train_processed_stats.csv'), index=True, header=False)

        dev_raw_df, dev_processed_df = dev_loader.dataset.compare_dataset_statistics()
        dev_raw_df.to_csv(os.path.join('stats', f'{args.experiment_name}_dev_raw_stats.csv'), index=True, header=False)
        dev_processed_df.to_csv(os.path.join('stats', f'{args.experiment_name}_dev_processed_stats.csv'), index=True, header=False)
